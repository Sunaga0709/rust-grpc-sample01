...
use gen::grpc_api::greet_v1::greet_service_server;
use gen::grpc_api::user_v1::user_service_server;

use service::greet::GreetService;

use infrastructure::persistence::user::User as UserRepoImpl;
use service::user::UserService;
use usecase::user::User as UserUsecase;
...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    // UserService
    let user_service = user_service_server::UserServiceServer::new(
            UserService::new(
