...
impl serde::Serialize for GreetRequest {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("greet_v1.GreetRequest", len)?;
        if !self.name.is_empty() {
...
impl<'de> serde::Deserialize<'de> for GreetRequest {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct greet_v1.GreetRequest")
            }
        ...
        deserializer.deserialize_struct("greet_v1.GreetRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for GreetResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("greet_v1.GreetResponse", len)?;
        if !self.text.is_empty() {
...
impl<'de> serde::Deserialize<'de> for GreetResponse {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct greet_v1.GreetResponse")
            }
        ...
        deserializer.deserialize_struct("greet_v1.GreetResponse", FIELDS, GeneratedVisitor)
    }
}
