...
impl serde::Serialize for BloodType {
        ...
        S: serde::Serializer,
    {
        let variant = match self {
            Self::Unspecified => "BLOOD_TYPE_UNSPECIFIED",
            Self::A => "BLOOD_TYPE_A",
            Self::B => "BLOOD_TYPE_B",
            Self::O => "BLOOD_TYPE_O",
            Self::Ab => "BLOOD_TYPE_AB",
        };
...
impl<'de> serde::Deserialize<'de> for BloodType {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            {
                match value {
                    "BLOOD_TYPE_UNSPECIFIED" => Ok(BloodType::Unspecified),
                    "BLOOD_TYPE_A" => Ok(BloodType::A),
                    "BLOOD_TYPE_B" => Ok(BloodType::B),
                    "BLOOD_TYPE_O" => Ok(BloodType::O),
                    "BLOOD_TYPE_AB" => Ok(BloodType::Ab),
...
impl serde::Serialize for CreateUserRequest {
        ...
        S: serde::Serializer,
    {
        ...
        if self.blood_type != 0 {
            len += 1;
        }
        let mut struct_ser = serializer.serialize_struct("user_v1.CreateUserRequest", len)?;
        if !self.name.is_empty() {
            struct_ser.serialize_field("name", &self.name)?;
        }
        if self.birthday != 0 {
            struct_ser.serialize_field("birthday", &self.birthday)?;
        }
        if !self.email.is_empty() {
            struct_ser.serialize_field("email", &self.email)?;
        }
        if self.blood_type != 0 {
            let v = BloodType::from_i32(self.blood_type)
                .ok_or_else(|| serde::ser::Error::custom(format!("Invalid variant {}", self.blood_type)))?;
...
impl<'de> serde::Deserialize<'de> for CreateUserRequest {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct user_v1.CreateUserRequest")
            }
                    ...
                    V: serde::de::MapAccess<'de>,
            {
                ...
                while let Some(k) = map.next_key()? {
                    match k {
                        ...
                        GeneratedField::BloodType => {
                            ...
                            blood_type__ = Some(map.next_value::<BloodType>()? as i32);
                        }
                    }
                }
                Ok(CreateUserRequest {
                    ...
                    blood_type: blood_type__.unwrap_or_default(),
                })
            }
        }
        deserializer.deserialize_struct("user_v1.CreateUserRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for CreateUserResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("user_v1.CreateUserResponse", len)?;
        if !self.user_id.is_empty() {
...
impl<'de> serde::Deserialize<'de> for CreateUserResponse {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct user_v1.CreateUserResponse")
            }
        ...
        deserializer.deserialize_struct("user_v1.CreateUserResponse", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for DeleteUserRequest {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("user_v1.DeleteUserRequest", len)?;
        if !self.user_id.is_empty() {
            struct_ser.serialize_field("userId", &self.user_id)?;
        }
        struct_ser.end()
...
impl<'de> serde::Deserialize<'de> for DeleteUserRequest {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct user_v1.DeleteUserRequest")
            }
        ...
        deserializer.deserialize_struct("user_v1.DeleteUserRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for DeleteUserResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("user_v1.DeleteUserResponse", len)?;
        if !self.message.is_empty() {
...
impl<'de> serde::Deserialize<'de> for DeleteUserResponse {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct user_v1.DeleteUserResponse")
            }

            fn visit_map<V>(self, mut map: V) -> std::result::Result<DeleteUserResponse, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
        ...
        deserializer.deserialize_struct("user_v1.DeleteUserResponse", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for GetUserRequest {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("user_v1.GetUserRequest", len)?;
        if !self.user_id.is_empty() {
            struct_ser.serialize_field("userId", &self.user_id)?;
        }
        struct_ser.end()
...
impl<'de> serde::Deserialize<'de> for GetUserRequest {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct user_v1.GetUserRequest")
            }
        ...
        deserializer.deserialize_struct("user_v1.GetUserRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for GetUserResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("user_v1.GetUserResponse", len)?;
...
impl<'de> serde::Deserialize<'de> for GetUserResponse {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct user_v1.GetUserResponse")
            }
        ...
        deserializer.deserialize_struct("user_v1.GetUserResponse", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for ListUserRequest {
        ...
        S: serde::Serializer,
    {
        use serde::ser::SerializeStruct;
        let len = 0;
        let struct_ser = serializer.serialize_struct("user_v1.ListUserRequest", len)?;
        struct_ser.end()
    }
}
impl<'de> serde::Deserialize<'de> for ListUserRequest {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct user_v1.ListUserRequest")
            }
        ...
        deserializer.deserialize_struct("user_v1.ListUserRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for ListUserResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("user_v1.ListUserResponse", len)?;
        if !self.users.is_empty() {
...
impl<'de> serde::Deserialize<'de> for ListUserResponse {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct user_v1.ListUserResponse")
            }
        ...
        deserializer.deserialize_struct("user_v1.ListUserResponse", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for UpdateUserRequest {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("user_v1.UpdateUserRequest", len)?;
        if !self.user_id.is_empty() {
            struct_ser.serialize_field("userId", &self.user_id)?;
        }
        if !self.name.is_empty() {
...
impl<'de> serde::Deserialize<'de> for UpdateUserRequest {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct user_v1.UpdateUserRequest")
            }
        ...
        deserializer.deserialize_struct("user_v1.UpdateUserRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for UpdateUserResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("user_v1.UpdateUserResponse", len)?;
        if !self.message.is_empty() {
            struct_ser.serialize_field("message", &self.message)?;
        }
        struct_ser.end()
...
impl<'de> serde::Deserialize<'de> for UpdateUserResponse {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct user_v1.UpdateUserResponse")
            }
        ...
        deserializer.deserialize_struct("user_v1.UpdateUserResponse", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for User {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("user_v1.User", len)?;
        if !self.user_id.is_empty() {
            struct_ser.serialize_field("userId", &self.user_id)?;
        }
        if !self.name.is_empty() {
...
impl<'de> serde::Deserialize<'de> for User {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct user_v1.User")
            }
        ...
        deserializer.deserialize_struct("user_v1.User", FIELDS, GeneratedVisitor)
    }
}
